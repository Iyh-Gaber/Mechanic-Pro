        ...
        child: Column(
          ...
          children: [
            ...
            ContactCard(
              ...
              title: LocaleKeys.ContactUsbyChat.tr(), // ستحتاج لإضافة هذا المفتاح لملف الترجمة الخاص بك
            ...
            Row(
              ...
              children: [
                SocialMediaIcon(icon: Icons.facebook, label: LocaleKeys.facebook.tr(), onTap: () => _launchURL(facebookUrl)),
                SocialMediaIcon(icon: Icons.chat, label: LocaleKeys.ContactUsbyChat.tr(), onTap: () => _launchURL(whatsappUrl)), // أضفنا الواتساب لوسائل التواصل الاجتماعي
                SocialMediaIcon(icon: Icons.flutter_dash, label: LocaleKeys.twitter.tr(), onTap: () => _launchURL(twitterUrl)), // تم تغيير الأيقونة لأيقونة عامة
                SocialMediaIcon(icon: Icons.camera_alt, label: LocaleKeys.instagram.tr(), onTap: () => _launchURL(instagramUrl)), // تم تغيير الأيقونة لأيقونة عامة
              ],
            ),
          ],
        ),
