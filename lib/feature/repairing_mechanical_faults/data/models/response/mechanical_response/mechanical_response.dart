import 'datum_mechanical.dart';

class MechanicalResponse {
  List<DatumMechanical>? data;
  ...
  factory MechanicalResponse.fromJson(Map<String, dynamic> json) {
    return MechanicalResponse(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => DatumMechanical.fromJson(e as Map<String, dynamic>))
          .toList(),
