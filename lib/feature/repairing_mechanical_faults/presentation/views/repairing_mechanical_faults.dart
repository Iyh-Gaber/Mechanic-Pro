...
import 'package:mechpro/core/translate/locale_keys.g.dart'; // استيراد مفاتيح الترجمة
import 'package:mechpro/core/utils/app_color.dart'; // استيراد الألوان
import 'package:mechpro/core/utils/text_style.dart'; // استيراد أنماط النص
import 'package:mechpro/core/extenstions/extentions.dart'; // لاستخدام extentions (مثل pushNamed)
import 'package:mechpro/feature/repairing_mechanical_faults/data/models/response/mechanical_response/datum_mechanical.dart'; // استيراد DatumMechanical
import 'package:mechpro/feature/regular_maintenance/presentation/widgets/date_time_picker_part.dart'; // استيراد DateTimePickerPart
import 'package:mechpro/feature/regular_maintenance/presentation/widgets/location_part.dart'; // استيراد LocationPart
...
class _RepairingMechanicalFaultsViewState
  ...
  void _confirmService() {
    ...
    // عرض تفاصيل الطلب في AlertDialog قبل الإرسال
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                ...
                print('تم الضغط على زر الحجز لـ: Mechanical Repair Service');
              },
              child: Text(LocaleKeys.Confirm.tr()),
            ),
          ],
