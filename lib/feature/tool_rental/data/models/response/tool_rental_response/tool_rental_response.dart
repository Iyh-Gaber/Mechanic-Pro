import 'datum_tool_rental.dart';

class ToolRentalResponse {
  List<DatumToolRental>? data;
  ...
  factory ToolRentalResponse.fromJson(Map<String, dynamic> json) {
    return ToolRentalResponse(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => DatumToolRental.fromJson(e as Map<String, dynamic>))
          .toList(),
