...
class RepairingElectricalFaults extends StatelessWidget {
...
import '../cubit/electrical_cubit.dart'; // تأكد من استيراد الكيوبت الصحيح
import '../cubit/electrical_state.dart'; // تأكد من استيراد الحالة الصحيحة
// تأكد من استيراد الموديل الصحيح
...
class _RepairingElectricalFaultsState extends State<RepairingElectricalFaults> {
  ...
  static final Map<String, IconData> _serviceIcons = {
    ...
    'Alternator Repair': Icons.power_input,
    'Starter Motor Issues': Icons.electric_car,
    'Wiring and Fuses': Icons.electrical_services,
    'Lighting System': Icons.lightbulb,
    'Power Window/Lock Repair': Icons.window,
    'Dashboard & Gauge Repair': Icons.dashboard,
    'Computer Diagnostics (ECU)': Icons.memory,
    'Other Electrical Issues': Icons.miscellaneous_services,
  };
          ...
          actions: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                ...
                print('Service Confirmed for Electrical Faults:');
        ...
        child: ListView(
          children: [
            ...
            BlocBuilder<ElectricalCubit, ElectricalState>(
              // استخدام ElectricalCubit و ElectricalState
...
class _RepairingElectricalFaultsState extends State<RepairingElectricalFaults> {
  ...
  // دالة لعرض نافذة تأكيد الطلب وإرسال الطلب إلى الـ API
  void _confirmService() {
              ...
              BlocBuilder<ElectricalCubit, ElectricalState>(
                builder: (context, state) {
                  if (state is ElectricalLoadingState) {
                    ...
                    // التعديل هنا: تحويل البيانات بشكل صريح إلى List<DatumElectrical>
                    final List<DatumElectrical> electricalServices =
