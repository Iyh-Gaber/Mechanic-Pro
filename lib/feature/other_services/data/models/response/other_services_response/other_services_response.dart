import 'datum_other_services.dart';

class OtherServicesResponse {
  List<DatumOtherServices>? data;
  ...
  factory OtherServicesResponse.fromJson(Map<String, dynamic> json) {
    return OtherServicesResponse(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => DatumOtherServices.fromJson(e as Map<String, dynamic>))
          .toList(),
